...
public class MyService {
	...
	public void saveUser(HttpServletRequest req,HttpServletResponse resp) throws IOException, ServletException {
		...
		if(age<18) {
			resp.getWriter().print("<h1 align='center' style='color:red'>you are not eligible for Create Account</h1>");
			...
			if(customer2==null) {
				resp.getWriter().print("<h1 align='center' style='color:green'>Account Create success</h1>");
				req.getRequestDispatcher("Login.html").include(req, resp);
				dao.saveCustomer(customer);
			}
			else {
				resp.getWriter().print("<h1 align='center' style='color:red'>Account Already Exists</h1>");
				req.getRequestDispatcher("SignUp.html").include(req, resp);
			}
		}
	}
	public void login(HttpServletRequest req,HttpServletResponse resp) throws IOException, ServletException {
		...
		else if(password.equals(AES.decrypt(customer.getPassword(),"123")))
		{
